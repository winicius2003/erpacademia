          ...
          <div className="mx-auto max-w-3xl">
            <Card className="shadow-2xl border-primary ring-2 ring-primary/50">
                <CardHeader className="text-center p-8 bg-primary/5">
                    <CardTitle className="text-3xl font-headline">Plano Completo com Oferta de Lançamento</CardTitle>
                    <CardDescription>Acesso total a todas as funcionalidades, sem pegadinhas ou taxas escondidas.</CardDescription>
                </CardHeader>
                <CardContent className="p-8">
                    <div className="text-center mb-8">
                        <p className="text-sm text-muted-foreground uppercase font-semibold">14 DIAS DE TESTE GRÁTIS</p>
                        <p className="text-5xl font-extrabold mt-2">R$ 59<span className="text-2xl font-semibold text-muted-foreground">,99</span><span className="text-xl font-normal text-muted-foreground">/mês</span></p>
                        <p className="text-muted-foreground mt-1">durante os 3 primeiros meses.</p>
                        <p className="font-semibold mt-4">Após o período, R$ 450,00/mês.</p>
