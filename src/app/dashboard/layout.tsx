...
const navPermissions: Record<Role, string[]> = {
  Admin: ["Painel", "Alunos", "Treinos", "Avaliações", "Agenda", "Financeiro", "CRM", "Frequência", "Controle de Acesso", "Relatórios", "Gympass", "Planos", "Produtos", "Assinatura", "Configurações"],
  ...
  Recepção: ["Alunos", "Agenda", "Financeiro", "CRM", "Controle de Acesso", "Produtos"],
