...
export default function FinancialPage() {
                    ...
                    <CardHeader>
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <Button onClick={() => setIsPaymentDialogOpen(true)} disabled={isSalesBlocked} title={isSalesBlocked ? "Bloqueado por pendência" : ""}><PlusCircle className="mr-2 h-4 w-4" />Registrar Pagamento</Button>
                            </div>
                        </div>
                    </CardHeader>
                    <CardContent>
  ...
  <change>
    <file>/src/services/expenses.ts</file>
    <content><![CDATA[
'use server';
