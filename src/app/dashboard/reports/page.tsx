      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Listas de alunos baseadas no status atual.</CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Acompanhe a saúde financeira da academia.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-3">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Acompanhe a evolução física dos alunos.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-3">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Gere declarações e outros documentos.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-3">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Dados sobre a atividade dos alunos.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-3">
