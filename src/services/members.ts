...
let members: Omit<Member, 'status' | 'attendanceStatus'>[] = [
  { id: '1', name: 'João da Silva', email: 'joao.silva@example.com', password: '123', loginMethod: 'password', phone: '(11) 98765-4321', plan: 'Anual', expires: format(addMonths(new Date(), 10), 'yyyy-MM-dd'), createdAt: '2023-08-15', cpf: "111.222.333-44", rg: "12.345.678-9", dob: '1990-05-10', address: defaultAddress, professor: 'Marcos Rocha', lastSeen: format(new Date(), 'yyyy-MM-dd'), workoutStatus: 'Completo', goal: 'Hipertrofia', notes: 'Relatou dor no ombro esquerdo.', accessPin: '1234', fingerprintRegistered: true, assignedPlanId: '1', medicalNotes: 'Atestado médico válido até 2025-01-01. Liberado para atividades de alto impacto.' },
  { id: '2', name: 'Maria Oliveira', email: 'maria.oliveira@gmail.com', loginMethod: 'google', phone: '(21) 91234-5678', plan: 'Mensal', expires: format(addMonths(new Date(), 1), 'yyyy-MM-dd'), createdAt: '2024-06-01', cpf: "222.333.444-55", rg: "23.456.789-0", dob: '1995-07-22', address: defaultAddress, professor: 'Fernando Costa', lastSeen: format(subDays(new Date(), 5), 'yyyy-MM-dd'), workoutStatus: 'Pendente', goal: 'Emagrecimento', notes: '', accessPin: '5678', fingerprintRegistered: false, medicalNotes: 'Atestado de aptidão para atividades físicas gerais.' },
  { id: '3', name: 'Carlos Pereira', email: 'carlos.pereira@example.com', password: '123', loginMethod: 'password', phone: '(31) 95555-4444', plan: 'Trimestral', expires: format(addMonths(new Date(), 2), 'yyyy-MM-dd'), createdAt: '2024-05-10', cpf: "333.444.555-66", rg: "34.567.890-1", dob: '1985-11-23', address: defaultAddress, professor: 'Marcos Rocha', lastSeen: format(subDays(new Date(), 2), 'yyyy-MM-dd'), workoutStatus: 'Completo', goal: 'Definição muscular', notes: 'Asma, usar bombinha se necessário.', accessPin: '9012', fingerprintRegistered: true },
  { id: '4', name: 'Ana Costa', email: 'ana.costa@example.com', password: '123', loginMethod: 'password', phone: '(41) 98888-7777', plan: 'Anual', expires: format(addMonths(new Date(), 6), 'yyyy-MM-dd'), createdAt: '2024-07-01', cpf: "444.555.666-77", rg: "45.678.901-2", dob: '2000-02-15', address: defaultAddress, professor: 'Marcos Rocha', lastSeen: format(subDays(new Date(), 10), 'yyyy-MM-dd'), workoutStatus: 'Pendente', goal: 'Condicionamento físico', notes: '', accessPin: '4444', fingerprintRegistered: false },
  { id: '5', name: 'Bruno Santos', email: 'bruno.santos@gmail.com', loginMethod: 'google', phone: '(51) 97777-6666', plan: 'Mensal', expires: format(addMonths(new Date(), 1), 'yyyy-MM-dd'), createdAt: '2024-07-18', cpf: "555.666.777-88", rg: "56.789.012-3", dob: '1998-09-30', address: defaultAddress, professor: 'Fernando Costa', lastSeen: format(subDays(new Date(), 1), 'yyyy-MM-dd'), workoutStatus: 'Pendente', goal: 'Ganho de força', notes: '', accessPin: '4321', fingerprintRegistered: false },
  { id: '6', name: 'Débora Martins', email: 'debora.martins@example.com', password: '123', loginMethod: 'password', phone: '(61) 96666-5555', plan: 'Mensal', expires: format(addMonths(new Date(), -2), 'yyyy-MM-dd'), createdAt: '2024-01-20', cpf: "666.777.888-99", rg: "67.890.123-4", dob: '1995-03-20', address: defaultAddress, professor: 'Marcos Rocha', lastSeen: format(subDays(new Date(), 60), 'yyyy-MM-dd'), workoutStatus: 'Completo', goal: 'Manutenção', notes: '', accessPin: '1122', fingerprintRegistered: true },
  { id: '7', name: 'Pedro Junior', email: 'pedro.junior@example.com', password: '123', loginMethod: 'password', phone: '(71) 91111-2222', plan: 'Mensal', expires: format(addMonths(new Date(), 1), 'yyyy-MM-dd'), createdAt: '2024-07-15', cpf: "777.888.999-00", rg: "78.901.234-5", dob: '2010-08-15', address: defaultAddress, professor: 'Marcos Rocha', lastSeen: format(new Date(), 'yyyy-MM-dd'), workoutStatus: 'Pendente', goal: 'Iniciação Esportiva', notes: '', accessPin: '7788', fingerprintRegistered: false, guardian: { name: 'Pedro Pai', cpf: '123.456.789-00', phone: '(71) 93333-4444' } },
];
