...
let members: Member[] = [
  ...
  { id: '4', name: 'Ana Costa', email: 'ana.costa@example.com', phone: '(41) 98888-7777', plan: 'Anual', status: 'Inativo', expires: format(addMonths(new Date(), -2), 'yyyy-MM-dd'), cpf: "444.555.666-77", rg: "45.678.901-2", dob: '2000-02-15', professor: 'Não atribuído', attendanceStatus: 'Faltante', workoutStatus: 'Pendente', goal: 'Condicionamento físico', notes: '', accessPin: '', fingerprintRegistered: false },
