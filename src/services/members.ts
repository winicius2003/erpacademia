...
// --- In-Memory Database ---
let members: Member[] = [
  { id: '1', name: 'João da Silva', email: 'joao.silva@example.com', phone: '(11) 98765-4321', plan: 'Anual', status: 'Ativo', expires: format(addMonths(new Date(), 10), 'yyyy-MM-dd'), cpf: "111.222.333-44", rg: "12.345.678-9", dob: '1990-05-10', professor: 'Marcos Rocha', attendanceStatus: 'Presente', workoutStatus: 'Completo', goal: 'Hipertrofia', notes: 'Relatou dor no ombro esquerdo.', accessPin: '1234', fingerprintRegistered: true },
  // Maria is an example for birthday and absent student
  { id: '2', name: 'Maria Oliveira', email: 'maria.oliveira@example.com', phone: '(21) 91234-5678', plan: 'Mensal', status: 'Ativo', expires: format(addMonths(new Date(), 1), 'yyyy-MM-dd'), cpf: "222.333.444-55", rg: "23.456.789-0", dob: format(new Date(), 'yyyy-MM-dd'), professor: 'Fernando Costa', attendanceStatus: 'Faltante', workoutStatus: 'Pendente', goal: 'Emagrecimento', notes: 'Nenhuma observação.', accessPin: '5678', fingerprintRegistered: false },
  // Carlos is an example for overdue student
  { id: '3', name: 'Carlos Pereira', email: 'carlos.pereira@example.com', phone: '(31) 95555-4444', plan: 'Trimestral', status: 'Atrasado', expires: format(addMonths(new Date(), -1), 'yyyy-MM-dd'), cpf: "333.444.555-66", rg: "34.567.890-1", dob: '1985-11-23', professor: 'Marcos Rocha', attendanceStatus: 'Presente', workoutStatus: 'Completo', goal: 'Definição muscular', notes: 'Asma, usar bombinha se necessário.', accessPin: '9012', fingerprintRegistered: true },
  // Ana is another example for absent student (risk group)
  { id: '4', name: 'Ana Costa', email: 'ana.costa@example.com', phone: '(41) 98888-7777', plan: 'Anual', status: 'Ativo', expires: format(addMonths(new Date(), 6), 'yyyy-MM-dd'), cpf: "444.555.666-77", rg: "45.678.901-2", dob: '2000-02-15', professor: 'Marcos Rocha', attendanceStatus: 'Faltante', workoutStatus: 'Pendente', goal: 'Condicionamento físico', notes: '', accessPin: '4444', fingerprintRegistered: false },
  // Bruno is another normal active student
