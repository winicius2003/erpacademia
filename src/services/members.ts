...
let members: Omit<Member, 'status' | 'attendanceStatus'>[] = [
  { id: '1', name: 'João da Silva', email: 'joao.silva@example.com', password: '123', loginMethod: 'password', phone: '(11) 98765-4321', plan: 'Anual', expires: format(addMonths(new Date(), 10), 'yyyy-MM-dd'), cpf: "111.222.333-44", rg: "12.345.678-9", dob: '1990-05-10', address: defaultAddress, professor: 'Marcos Rocha', lastSeen: format(new Date(), 'yyyy-MM-dd'), workoutStatus: 'Completo', goal: 'Hipertrofia', notes: 'Relatou dor no ombro esquerdo.', accessPin: '1234', fingerprintRegistered: true, assignedPlanId: '1', medicalNotes: 'Atestado médico válido até 2025-01-01. Liberado para atividades de alto impacto.' },
  { id: '2', name: 'Maria Oliveira', email: 'maria.oliveira@gmail.com', loginMethod: 'google', phone: '(21) 91234-5678', plan: 'Mensal', expires: format(addMonths(new Date(), 1), 'yyyy-MM-dd'), cpf: "222.333.444-55", rg: "23.456.789-0", dob: '1995-07-22', address: defaultAddress, professor: 'Fernando Costa', lastSeen: format(subDays(new Date(), 5), 'yyyy-MM-dd'), workoutStatus: 'Pendente', goal: 'Emagrecimento', notes: '', accessPin: '5678', fingerprintRegistered: false, medicalNotes: 'Atestado de aptidão para atividades físicas gerais.' },
  { id: '3', name: 'Carlos Pereira', email: 'carlos.pereira@example.com', password: '123', loginMethod: 'password', phone: '(31) 95555-4444', plan: 'Trimestral', expires: format(addMonths(new Date(), 2), 'yyyy-MM-dd'), cpf: "333.444.555-66", rg: "34.567.890-1", dob: '1985-11-23', address: defaultAddress, professor: 'Marcos Rocha', lastSeen: format(subDays(new Date(), 2), 'yyyy-MM-dd'), workoutStatus: 'Completo', goal: 'Definição muscular', notes: 'Asma, usar bombinha se necessário.', accessPin: '9012', fingerprintRegistered: true },
...
export async function addMember(memberData: Omit<Member, 'id' | 'password' | 'loginMethod' | 'status' | 'attendanceStatus'>): Promise<Member> {
